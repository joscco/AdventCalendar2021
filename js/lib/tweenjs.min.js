...
this.createjs = this.createjs || {}, createjs.extend = function (a, b) {
    ...
    Tween.IGNORE = {}, Tween._tweens = [], Tween._plugins = null, Tween._tweenHead = null, Tween._tweenTail = null, Tween.get = function (a, b) {
        ...
        if (!(this.passive = !!a.passive)) {
            var d, e, f, g, h = a.prev.props, i = a.props;
            (g = a.ease) && (b = g(b, 0, 1, 1));
            var j = this._plugins;
            a:for (var k in h) {
                if (e = h[k], f = i[k], d = e !== f && "number" == typeof e ? e + (f - e) * b : b >= 1 ? f : e, j) for (var l = 0, m = j.length; m > l; l++) {
        ...
        var d, e, f, g, h, i = this._stepHead.props, j = this.target, k = Tween._plugins, l = b.prev, m = l.props,
            n = b.props || (b.props = this._cloneProps(m)), o = {};
        for (d in a) if (a.hasOwnProperty(d) && (o[d] = n[d] = a[d], void 0 === i[d])) {
            if (g = void 0, k) for (e = k.length - 1; e >= 0; e--) if (f = k[e].init(this, d, g), void 0 !== f && (g = f), g === Tween.IGNORE) {
        ...
        for (d in o) {
            f = a[d];
            for (var p, q = l; (p = q) && (q = p.prev);) if (q.props !== p.props) {
    ...
    a.priority = 0, a.ID = "MotionGuide", a.install = function () {
        ...
        for (var e in d) if ("guide" === e) {
            var f = c.props.guide, g = a._solveGuideData(d.guide, f);
            f.valid = !g;
            var h = f.endData;
        ...
        var f, g = b.path, h = g.length, i = 3, j = 9;
        ...
        var x = isNaN(b.start) ? 0 : b.start, y = isNaN(b.end) ? 1 : b.end;
        ...
        var e, f, g, h, i, j = c.subLines, k = 0, l = 10, m = b * c.animSpan + c.startData.ratio;
